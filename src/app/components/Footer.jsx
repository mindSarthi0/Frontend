        ...
        <div className="flex-3 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:order-1 order-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/legal?section=privacy" className="hover:underline">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/legal?section=refund" className="hover:underline">
                  Refund and Cancellation
                </Link>
              </li>
              <li>
                <Link href="/legal?section=pricing" className="hover:underline">
                  Pricing
                </Link>
              </li>
              <li>
                <Link
                  href="/legal?section=shipping"
              ...
              <li>
                <Link href="/legal?section=contact" className="hover:underline">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link
                  href="/legal?section=services"
                  className="hover:underline"
                >
                  Our Services
                </Link>
